...
export default function Providers({navigation}) {
    ...
    //         if(providers[i].name.includes(value)){
    //             setfilteredProviders([...filteredProviders,providers[i]]);
    //         }
    //     }
    //     setQuery(value)
    ...
    var tempProvider={
        ...
        location :'',
        workingHours :[{start:"10:00",break:"12:00",endbreak:"12:30",end:"17:00",day:'sunday'}],
    ...
    var providers = [
        tempProvider,tempProvider2,tempProvider,tempProvider,tempProvider,tempProvider,tempProvider,
            ...
            />
            {
                ...
                filteredProviders.map(provider=>{
                    return(
                        ...
                        onPress={()=> {
                         navigation.navigate('AppointmentDetails',{userInput:{orgname:provider.name,img:provider.image,services:provider.services}})} }>
